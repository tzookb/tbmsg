...
3. Now add the service provider to your app.php file: "'Tzookb\TBMsg\ServiceProviders\TBMsgServiceProvider'"
...
5. now you would need to publish the config and migrations with
    "php artisan vendor:publish --provider="Tzookb\TBMsg\ServiceProviders\TBMsgServiceProvider""
